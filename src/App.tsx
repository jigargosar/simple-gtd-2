...
function ViewHeader() {
    return (
        <header className="border-b border-gray-500 bg-gray-500 px-6 py-5">
...
function ViewSection({ section }: { section: Section }) {
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="overflow-hidden rounded-lg border border-gray-300 bg-gray-200 shadow-sm">
                {tasks.map((task) => (
                    <ViewTask key={task.id} task={task} />
                ))}
                <div className="border-t border-gray-300 px-5 py-2.5">
...
function ViewTask({ task: { done, id, title } }: { task: Task }) {
    return (
        <div className="group flex items-center gap-4 border-b border-gray-300 px-5 py-4 last:border-b-0">
