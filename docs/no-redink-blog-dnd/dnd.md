...
A screenshot of the Trello app, showing a card being dragged from one list to another.
...
Dragging to select a continuous region of time across a bar showing the hours of the day.
...
Grabbing a node of an outline and dragging it to a different parent node
