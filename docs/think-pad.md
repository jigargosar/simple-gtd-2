...
## High — file is incomplete or contradictory
...
5. **Fix typos**:
   ...
   8. "Redicilous" → "Ridiculous" (6.5)
   9. "spelucative asicii" → "speculative ascii" (6.6)
10. **Self-contradiction** — rule 1 says numbering must be "serial and unique within a response" but rule 6 sub-items restart at 1. Decide:
...
18. Global CLAUDE.md overlap with new Easy Flow — rationalize later
